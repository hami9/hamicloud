...
- Pinned service images by verified cryptographic digest:
...
- Every row cites its authoritative provenance (e.g. CI logs, `pip freeze`, `go version`, `docker pull`).
...
- Pinned all service images in `deploy/compose/docker-compose.yml` to cryptographic digests:
  - `postgres:16-alpine@sha256:cf78e76683b9ca8c5733cbbdce6c9262b45b6767934dd0a95e671f9a0fc20685`
  - `redis:7.2-alpine@sha256:ccd6aa8d45ff3f033d6fa15b8cc1a50579f65c89f38cf9bb607a954c4f2128ed`
  ...
  - `quay.io/keycloak/keycloak:24.0.5@sha256:f8ade94c1d0ad2f2fa7734a455fee5392764f402c43ca35e9af6bf63a2541dc9` (Decision D7)
...
#### 5. T28 · The Red Path & Continuous Integration Verification
- **Passing CI Run:**
  - Commit: `19a7dd3` (`Fix CI digests`)
  - Run ID: `36032046144`
  - URL: [https://github.com/hami9/hamicloud/actions/runs/36032046144](https://github.com/hami9/hamicloud/actions/runs/36032046144)
  - Result: **100% GREEN** (`Go Build & Concurrency Tests` in 19s, `Python Lint & Tests` in 52s).
- **Red Path Deliberate Falsification Run:**
  - Branch: `red-path` (commit `1c6a55f`, PR `#1`)
  - Breakage: Added deliberate assertion `assert False, "Deliberate red path test for CI falsification verification"` in `apps/api/tests/test_contracts.py`.
  - Run ID: `36032857051`
  - URL: [https://github.com/hami9/hamicloud/actions/runs/36032857051](https://github.com/hami9/hamicloud/actions/runs/36032857051)
  - Result: **FAILED** as expected (`Python Lint & Tests` failed in `Run Pytest` on `test_openapi_security_contract` with `AssertionError: Deliberate red path test for CI falsification verification`, while Go checks passed).
  - Cleanup: PR `#1` closed, `red-path` branch deleted locally and pruned from origin.
- **Milestone Checklist:**
